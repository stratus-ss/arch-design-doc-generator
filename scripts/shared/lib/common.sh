...
# Resolve this file's location. lib/ lives under scripts/shared/.
_COMMON_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
# scripts/shared/lib -> scripts/shared -> scripts -> project root
PROJECT_ROOT="${PROJECT_ROOT:-$(dirname "$(dirname "$(dirname "$_COMMON_DIR")")")}"
