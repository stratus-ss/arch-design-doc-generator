...
| `renumber_finding_sections.py` | After moving §6.2 blocks between P0–P3, rewrite numbers, §6.1, and anchors | `python3 scripts/health_check/renumber_finding_sections.py REPORT.md` |
