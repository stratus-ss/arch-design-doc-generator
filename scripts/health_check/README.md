...
- [Knowledge Base (KB) for recommendations and notes](../../README.md#knowledge-base-kb-for-recommendations-and-notes) — optional `verification` field, join-at-read, and why some `[[checks]]` rows only set `content_from`
