...
| `renumber_finding_sections.py` | After moving §6.2 blocks between P0–P3, rewrite numbers, §6.1, and anchors | `make hc-renumber-findings REPORT=path.md`; `DRY_RUN=1` to preview |
