...
# Bug: Collect infrastructureName nam-arl-01-pcq8r misses TSR whose Cluster Name is nam-arl-01
...
def test_discover_tsr_html_prefers_cluster_id(tmp_path: Path, project_root: Path) -> None:
    ...
    discovered = discover_tsr_html(
        tmp_path, cluster_id=cluster_id, cluster_name="fixture-cluster-pcq8r"
    )
