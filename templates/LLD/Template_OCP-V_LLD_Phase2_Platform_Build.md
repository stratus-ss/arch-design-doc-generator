...
**ODF Operator Subscription ({TIER_EDGE}):**
...
**StorageCluster CR — ODF internal mode on local NVMe ({TIER_EDGE}):**
...
10. **Set default StorageClass** for {TIER_EDGE}:
...
| {TIER_EDGE} footnote     | **Potentially 2 vNICs** — shared migration path | Density trade accepted                                               | ADR 11.3                    |
