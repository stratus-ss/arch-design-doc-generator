...
| ID      | Item                                                                                                 | Owner              | Status |
| ------- | ---------------------------------------------------------------------------------------------------- | ------------------ | ------ |
| CG-03-1 | Finalise the two-network-interface layout for {TIER_EDGE} nodes                                           | Network Team       | Open   |
...
| ID      | Item                                                                                                                          | Owner        | Status |
| ------- | ----------------------------------------------------------------------------------------------------------------------------- | ------------ | ------ |
| CG-04-1 | Decide the IP address management strategy for {TIER_EDGE} nodes (static allocation on shared /23 subnets confirmed or alternative) | Network Team | Open   |
...
| ID      | Item                                                                                       | Owner           | Status |
| ------- | ------------------------------------------------------------------------------------------ | --------------- | ------ |
| CG-05-1 | Confirm the NTP server(s) for {TIER_EDGE} clusters (tracked in LLD-13)                          | Network Team    | Open   |
...
| ID      | Item                                                                                            | Owner            | Status |
| ------- | ----------------------------------------------------------------------------------------------- | ---------------- | ------ |
| CG-09-1 | Assess {TIER_EDGE} network bandwidth and decide whether a local container image mirror is required   | Network Team     | Open   |
| CG-09-2 | Decide whether spoke clusters pull images directly from {REGISTRY_MIRROR} or via an ACM-hosted mirror | Platform | Open   |
...
| CG-11D-3 | Confirm WAN latency profile for {TIER_EDGE} hub-to-spoke paths; determine if klusterlet poll interval tuning is required                 | Platform / Network | Open   |
...
10. **Validate {TIER_EDGE} latency profile ({TIER_EDGE} hubs only):**
...
| ID      | Item                                        | Owner            | Status |
| ------- | ------------------------------------------- | ---------------- | ------ |
| CG-13-1 | Confirm the NTP server(s) to be used by {TIER_EDGE} clusters                                              | Network Team     | Open   |
