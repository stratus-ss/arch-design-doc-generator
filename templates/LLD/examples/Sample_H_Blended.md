...
| ID | Item | Owner | Status |
|----|------|-------|--------|
| CG-03-1 | {TIER_EDGE} 2-vNIC layout finalization | Network Team | Open |
...
| ID | Item | Owner | Status |
|----|------|-------|--------|
| CG-05-1 | {TIER_EDGE} NTP server confirmation | Network Team | Open |
...
| NTP servers | Internal NTP (site-specific) | {TIER_PRIMARY}/{TIER_MIDDLE}: SRE-managed; {TIER_EDGE}: TBD | HLD |
...
- [ ] Cluster name and base domain finalized
- [ ] Infoblox access
- [ ] Internal NTP server addresses confirmed ({TIER_PRIMARY}/{TIER_MIDDLE}); {TIER_EDGE} TBD
...
| FC SAN zoning | L2 | No storage path ({TIER_PRIMARY}/{TIER_MIDDLE}) | AC-03-5 |
