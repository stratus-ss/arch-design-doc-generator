...
gantt
    ...
    Hardware delivery and rack/stack     :hw, {HW_START}, {HW_DURATION}
    Prerequisites (DNS, certs, FW)       :prereq, after hw, {PREREQ_DURATION}
    Sandbox cluster deployment           :sandbox, after prereq, {SANDBOX_DURATION}
    Production cluster deployment        :prod1, after sandbox, {PROD1_DURATION}

    section Phase 2 — Platform Build
    Storage and network config           :p2stor, after prod1, {P2_STOR_DURATION}
    Identity, secrets, security          :p2sec, after p2stor, {P2_SEC_DURATION}
    Observability and CIS scanning       :p2obs, after p2sec, {P2_OBS_DURATION}

    section Phase 3 — Fleet Operations
    ACM fleet registration               :p3acm, after p2obs, {P3_ACM_DURATION}
    Upgrade strategy validation           :p3upg, after p3acm, {P3_UPG_DURATION}
    Remediation and compliance rollout    :p3rem, after p3upg, {P3_REM_DURATION}

    section Phase 4 — Migration
    Pilot wave (~20 VMs)                  :p4pilot, after p3rem, {P4_PILOT_DURATION}
    Production waves                      :p4prod, after p4pilot, {P4_PROD_DURATION}
    Holdback and decommission             :p4decom, after p4prod, {P4_DECOM_DURATION}
```
